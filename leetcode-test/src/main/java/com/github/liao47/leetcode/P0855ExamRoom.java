 ...
 *
 * 返回 ExamRoom(int N) 类，它有两个公开的函数：其中，函数 ExamRoom.seat() 会返回一个 int （整型数据），代表学生坐的位置；函数 ExamRoom.leave(int p) 代表坐在座位 p
 ...
 * @author liaoshiqing
 * @date 2022/12/30 9:52
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public class P0855ExamRoom {
    public static class ExamRoom1 {

 ...
 * 示例：
 *
 * ![示例](https://assets.leetcode-cn.com/aliyun-lc-upload/uploads/2020/11/15/q1.gif)
 *
 * 输入
...
public class P1656DesignAnOrderedStream {
    ...
    public static class OrderedStream2 {
        ...
        public List<String> insert(int idKey, String value) {
            values.set(idKey, value);
            if (idKey == ptr) {
                while (ptr < values.size() && values.get(ptr) != null) {
                    ptr++;
                }
                return values.subList(idKey, ptr);
            }
